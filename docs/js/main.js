		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				...
				['37',	'妖異の弁論家「ソフィスト」',			'ピューロス・アパンダ',			'42',	'',		'32.1',	'31.5',	'[3]ソフィスト',		'③ソフィスト',		'ソフィスト'	],
				...
				['41',	'稲妻の指揮者「アイトロス」',			'バル・アインハンダー',			'46',	'',		'10.1',	'14.2',	'[7]アイトロス',		'⑦アイトロス',		'アイトロス'	],
				['42',	'灼熱の突剣「レサト」',				'バードイーター',			'47',	'',		'12.6',	'11.0',	'[8]レサト',			'⑧レサト',		'レサト'	],
				['43',	'炎熱の巨人「エルドスルス」',			'ピューロスクラブ',			'48',	'',		'15.2',	'6.4',	'[9]エルドスルス',		'⑨エルドスルス',	'エルドス'	],
				['44',	'落涙の海燕「イリス」',				'ノーザンスワロー',			'49',	'',		'21.3',	'12.2',	'[10]イリス',			'⑩イリス',		'イリス'	],
				['45',	'奇跡の生還者「傭兵のレイムプリクス」',		'ブルーハンド・エスケーピー',		'50',	'',		'21.8',	'8.3',	'[11]レイムプリクス',		'⑪レイムプリクス',	'レイム'	],
				['46',	'電影将軍「ライトニング・ドゥクス」',		'マタンガ',				'51',	'雷',		'27.4',	'8.9',	'[12]ドゥクス',			'⑫ドゥクス',		'ドゥクス'	],
				['47',	'ランバージャック・デスマッチ',			'ピューロス・トレント',			'52',	'',		'30.3',	'11.3',	'[13]ランバージャック',		'⑬ランバージャック',	'ジャック'	],
				['48',	'知恵と戦の母「グラウコピス」',			'バル・スカネテ',			'53',	'',		'32.0',	'15.1',	'[14]グラウコピス',		'⑭グラウコピス',	'グラウコ'	],
				['49',	'相反する双子「イン・ヤン」',			'ピューロス・ヘクトアイズ',		'54',	'',		'11.4',	'34.2',	'[15]イン・ヤン',		'⑮イン・ヤン',		'インヤン'	],
				['50',	'嘲りの月狼「スコル」',				'ピューロス・シャック',			'55',	'吹雪',		'24.0',	'30.0',	'[16]スコル',			'⑯スコル',		'スコル'	],
				['50',	'炎蝶の女王「ペンテシレイア」',			'バル・ブラッドグライダー',		'55',	'灼熱',		'35.9',	'5.9',	'[17]ペンテシレイア',		'⑰ペンテシレイア',	'レイア'	],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		]
			...
			tempNMList = [
				...
				['Leucosia\\[(..):(..)\\]','NM01'],['Flauros\\[(..):(..)\\]','NM02'],['Sophist\\[(..):(..)\\]','NM03'],['Graffiacane\\[(..):(..)\\]','NM04'],['Askalaphos\\[(..):(..)\\]','NM05'],['DukeBatym\\[(..):(..)\\]','NM06'],['Aetolus\\[(..):(..)\\]','NM07'],['Lesath\\[(..):(..)\\]','NM08'],['Eldthurs\\[(..):(..)\\]','NM09'],['Iris\\[(..):(..)\\]','NM10'],['Lamebrix\\[(..):(..)\\]','NM11'],['Dux\\[(..):(..)\\]','NM12'],['Jack\\[(..):(..)\\]','NM13'],['Glaukopis\\[(..):(..)\\]','NM14'],['YingYang\\[(..):(..)\\]','NM15'],['Skoll\\[(..):(..)\\]','NM16'],['Penthesilea\\[(..):(..)\\]','NM17'],
				['([0-9]+):([0-9]+):[0-9]+.*レウコシアー','NM01'],
				['([0-9]+):([0-9]+):[0-9]+.*フラウロス','NM02'],
				['([0-9]+):([0-9]+):[0-9]+.*ソフィスト','NM03'],
				['([0-9]+):([0-9]+):[0-9]+.*グラッフアカーネ','NM04'],
				['([0-9]+):([0-9]+):[0-9]+.*アスカラポス','NM05'],
				['([0-9]+):([0-9]+):[0-9]+.*グランドデューク・バティム','NM06'],
				['([0-9]+):([0-9]+):[0-9]+.*アイトロス','NM07'],
				['([0-9]+):([0-9]+):[0-9]+.*レサト','NM08'],
				['([0-9]+):([0-9]+):[0-9]+.*エルドスルス','NM09'],
				['([0-9]+):([0-9]+):[0-9]+.*イリス','NM10'],
				['([0-9]+):([0-9]+):[0-9]+.*傭兵のレイムプリクス','NM11'],
				['([0-9]+):([0-9]+):[0-9]+.*ライトニング・ドゥクス','NM12'],
				['([0-9]+):([0-9]+):[0-9]+.*ランバージャック・デスマッチ','NM13'],
				['([0-9]+):([0-9]+):[0-9]+.*ウィーピングウィロー','NM13'],
				['([0-9]+):([0-9]+):[0-9]+.*グラウコピス','NM14'],
				['([0-9]+):([0-9]+):[0-9]+.*イン・ヤン','NM15'],
				['([0-9]+):([0-9]+):[0-9]+.*スコル','NM16'],
				['([0-9]+):([0-9]+):[0-9]+.*ペンテシレイア','NM17']
			];
