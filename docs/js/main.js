		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				...
				['40',	'深淵の大公「グランドデューク・バティム」',	'ダーク・トルバドゥール',		'45',	'',		'17',	'15',	'[6]グランドデューク・バティム','⑥バティム',		'バティム'	],
				['41',	'稲妻の指揮者「アイトロス」',			'バル・アインハンダー',			'46',	'',		'10',	'14',	'[7]アイトロス',		'⑦アイトロス',		'アイトロス'	],
				['42',	'灼熱の突剣「レサト」',				'バードイーター',			'47',	'',		'12',	'11',	'[8]バードイーター',		'⑧バードイーター',	'バードイーター'],
				['43',	'炎熱の巨人「エルドスルス」',			'ピューロスクラブ',			'48',	'',		'15',	'6',	'[9]エルドスルス',		'⑨エルドスルス',	'エルドスルス'	],
				['44',	'落涙の海燕「イリス」',				'ノーザンスワロー',			'49',	'',		'23',	'12',	'[10]イリス',			'⑩イリス',		'イリス'	],
				['45',	'奇跡の生還者「傭兵のレイムプリクス」',		'???',					'??',	'',		'21',	'8',	'[11]レイムプリクス',		'⑪レイムプリクス',	'レイムプリクス'],
				['46',	'電影将軍「ライトニング・ドゥクス」',		'???',					'??',	'',		'29',	'8',	'[12]ドゥクス',			'⑫ドゥクス',		'ドゥクス'	],
				['47',	'ランバージャック・デスマッチ',			'ピューロス・トレント',			'52',	'',		'30',	'10',	'[13]ランバージャック',		'⑬ランバージャック',	'ランバージャック'],
				['48',	'知恵と戦の母「グラウコピス」',			'???',					'??',	'',		'32',	'15',	'[14]グラウコピス',		'⑭グラウコピス',	'グラウコピス'	],
				['49',	'相反する双子「イン・ヤン」',			'ピューロス・ヘクトアイズ',		'54',	'',		'11',	'34',	'[15]イン・ヤン',		'⑮イン・ヤン',		'イン・ヤン'	],
				['50',	'嘲りの月狼「スコル」',				'???',					'??',	'',		'24',	'29',	'[16]スコル',			'⑯スコル',		'スコル'	],
				['50',	'炎蝶の女王「ペンテシレイア」',			'???',					'??',	'',		'35',	'6',	'[17]ペンテシレイア',		'⑰ペンテシレイア',	'ペンテシレイア'],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		]
			...
			tempNMList = [
				['レウコシア\\[(..):(..)\\]','NM01'],['フラウロス\\[(..):(..)\\]','NM02'],['ソフィスト\\[(..):(..)\\]','NM03'],['グラッフアカーネ\\[(..):(..)\\]','NM04'],['アスカラポス\\[(..):(..)\\]','NM05'],['グランドデューク・バティム\\[(..):(..)\\]','NM06'],['アイトロス\\[(..):(..)\\]','NM07'],['バードイーター\\[(..):(..)\\]','NM08'],['エルドスルス\\[(..):(..)\\]','NM09'],['イリス\\[(..):(..)\\]','NM10'],['レイムプリクス\\[(..):(..)\\]','NM11'],['ドゥクス\\[(..):(..)\\]','NM12'],['ランバージャック\\[(..):(..)\\]','NM13'],['グラウコピス\\[(..):(..)\\]','NM14'],['イン・ヤン\\[(..):(..)\\]','NM15'],['スコル\\[(..):(..)\\]','NM16'],['ペンテシレイア\\[(..):(..)\\]','NM17'],
				['レウコシア:(..):(..)','NM01'],['フラウロス:(..):(..)','NM02'],['ソフィスト:(..):(..)','NM03'],['グラッフ:(..):(..)','NM04'],['アスカラポス:(..):(..)','NM05'],['バティム:(..):(..)','NM06'],['アイトロス:(..):(..)','NM07'],['バードイーター:(..):(..)','NM08'],['エルドスルス:(..):(..)','NM09'],['イリス:(..):(..)','NM10'],['レイムプリクス:(..):(..)','NM11'],['ドゥクス:(..):(..)','NM12'],['ランバージャック:(..):(..)','NM13'],['グラウコピス:(..):(..)','NM14'],['イン・ヤン:(..):(..)','NM15'],['スコル:(..):(..)','NM16'],['ペンテシレイア:(..):(..)','NM17'],
				['グラッフ\\[(..):(..)\\]','NM04'],['バティム\\[(..):(..)\\]','NM06']
			];
