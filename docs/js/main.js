		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				...
				['39',	'書の守護者「アスカラポス」',			'グブラトーム',				'44',	'霊風',		'18',	'29',	'[5]アスカラポス',		'⑤アスカラポス',	'アスカラ'	],
				['40',	'深淵の大公「グランドデューク・バティム」',	'ダーク・トルバドゥール',		'45',	'ET19:00～5:59','17',	'15',	'[6]グランドデューク・バティム','⑥バティム',		'バティム'	],
				['41',	'稲妻の指揮者「アイトロス」',			'バル・アインハンダー',			'46',	'',		'10',	'14',	'[7]アイトロス',		'⑦アイトロス',		'アイトロス'	],
				['42',	'灼熱の突剣「レサト」',				'バードイーター',			'47',	'',		'12',	'11',	'[8]レサト',			'⑧レサト',		'レサト'	],
				['43',	'炎熱の巨人「エルドスルス」',			'ピューロスクラブ',			'48',	'',		'15',	'6',	'[9]エルドスルス',		'⑨エルドスルス',	'エルドス'	],
				...
				['49',	'相反する双子「イン・ヤン」',			'ピューロス・ヘクトアイズ',		'54',	'',		'11',	'34',	'[15]イン・ヤン',		'⑮イン・ヤン',		'インヤン'	],
				['50',	'嘲りの月狼「スコル」',				'ピューロス・シャック',			'55',	'吹雪',		'24',	'29',	'[16]スコル',			'⑯スコル',		'スコル'	],
				['50',	'炎蝶の女王「ペンテシレイア」',			'バル・ブラッドグライダー',		'55',	'灼熱',		'35',	'6',	'[17]ペンテシレイア',		'⑰ペンテシレイア',	'ペンテ'	],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',						'',					'',	'',		'99',	'99',	'',				'',			''		]
			...
			tempNMList = [
				...
				['グラッフ\\[(..):(..)\\]','NM04'],['バティム\\[(..):(..)\\]','NM06'],['アスカラ\\[(..):(..)\\]','NM05'],['エルドス\\[(..):(..)\\]','NM09'],['レイム\\[(..):(..)\\]','NM11'],['ジャック\\[(..):(..)\\]','NM13'],['グラウコ\\[(..):(..)\\]','NM14'],['インヤン\\[(..):(..)\\]','NM15'],['ペンテ\\[(..):(..)\\]','NM17']
			];
